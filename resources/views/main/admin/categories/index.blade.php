<x-app-layout>
    <div class="py-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 flex flex-wrap gap-3">
            ...
            <a href="{{ route('admin.categories.create') }}" class="flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50 dark:focus:ring-blue-700 shadow-md hover:shadow-lg active:scale-[0.98]">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all duration-200 hover:translate-y-[-2px] group">
                    <div class="p-5">
                        ...
                        <div class="mt-4 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            <a href="{{ route('admin.categories.show', $category->id) }}" class="px-2 py-1 text-xs bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                                Просмотр
                            </a>
                            <a href="{{ route('admin.categories.edit', $category->id) }}" class="px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors duration-150">
                                Изменить
                            </a>
