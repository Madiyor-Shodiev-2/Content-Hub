            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    <li class="inline-flex items-center">
                        <a href="{{ route('admin.genres.index') }}" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors duration-150">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('admin.genres.show', $genre->id) }}" class="ml-2 text-sm font-medium text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                                {{ $genre->name }}
                            </a>
                        </div>
                    </li>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $genre->name }}</h1>
                                <div class="mt-1 flex flex-wrap items-center text-sm text-gray-500 dark:text-gray-400 space-x-3">
                                    <span class="flex items-center">
                                        ...
                                        Создано: {{ $genre->created_at->format('d.m.Y') }}
                                    </span>
                                    <span class="flex items-center">
                                        <svg class="flex-shrink-0 mr-1.5 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path>
                                        </svg>
                                        Материалов: {{ $genre->contents->count() }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 sm:mt-0 flex space-x-3">
                            <a href="{{ route('admin.genres.edit', $genre) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150">
                ...
                <div class="px-6 py-5">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Всего контентов</p>
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $genre->contents->count() }}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Последнее обновление</p>
                                    <p class="text-lg font-medium text-gray-900 dark:text-white">{{ $genre->updated_at->format('d.m.Y H:i') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-6 py-5 border-t border-gray-200 dark:border-gray-700">
                    ...
                    @if($genre->contents->isEmpty())
                    <div class="text-center py-12 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h4 class="mt-3 text-lg font-medium text-gray-900 dark:text-white">Нет контентов</h4>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">В этой жанре пока нет контентов. Начните добавлять контенты, чтобы они появились здесь.</p>
                        <div class="mt-6">
