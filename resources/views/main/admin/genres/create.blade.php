    ...
    <div class="py-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-100 dark:border-gray-700 transition-all duration-200 hover:shadow-sm">
                <div class="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mt-1 max-w-2xl">
                                {{ __("Создавайте, редактируйте и управляйте жанрами контента в системе") }}
                            </p>
                            ...
                            <div class="mt-3 flex flex-wrap gap-3">
                                ...
                                <div class="inline-flex items-center text-sm font-medium px-2.5 py-0.5 rounded-full bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200">
                                    ...
                                    {{ __("Активно") }} {{ $genres->count() }} {{ trans_choice('жанр|жанрии', $genres->count()) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0 flex flex-col sm:flex-row gap-2">
                        ...
                        <a href="{{ route('admin.genres.index') }}" class="flex items-center justify-center px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-indigo-300 focus:ring-opacity-50 shadow-md hover:shadow-lg active:scale-[0.98]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="modal-container min-h-screen flex items-center justify-center p-4">
                <div class="modal-content bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md transform transition-all">
                    ...
                    <div class="modal-body p-6">
                        <form action="{{ route('admin.genres.store') }}" id="addAuthorForm" class="space-y-4" method="POST">
                            @csrf
                            @method('POST')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-dashed border-gray-300 dark:border-gray-700 p-8 text-center hidden">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __("Жанры не найдены") }}</h3>
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    {{ __("Попробуйте изменить параметры поиска или добавьте новые жанры с помощью кнопки выше") }}
                </p>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">{{ $genre->contents->count() }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('admin.genres.show', $genre->id) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 transition-colors duration-200 p-1 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/30">
                                        ...
                                        <a href="{{ route('admin.genres.edit', $genre->id) }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300 transition-colors duration-200 p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </a>

                                        <form action="{{ route('admin.genres.destroy', $genre->id) }}" method="POST" onsubmit="return confirm('Удалить жанра?')">
                                            @csrf
                                            @method('DELETE')
