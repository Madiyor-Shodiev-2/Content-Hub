<x-app-layout>
    ...
    <div class="py-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 flex flex-wrap gap-3">
            ...
            <a href="{{ route('admin.authors.create') }}" class="flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50 dark:focus:ring-blue-700 shadow-md hover:shadow-lg active:scale-[0.98]">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-700 transition-all duration-200 hover:translate-y-[-2px]">
                ...
                <div class="px-6 pb-6 md:px-8 md:pb-8">
                    <div class="border-t border-gray-100 dark:border-gray-700 pt-6 flex space-x-3">
                        <a href="{{ route('admin.authors.show', $author->id) }}" class="px-4 py-2 bg-blue-700 border border-blue-300 dark:border-blue-600 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-700 rounded-lg font-medium transition-colors duration-200">
                            Посмотреть
                        </a>
                        <a href="{{ route('admin.authors.edit', $author->id) }}" class="px-4 py-2 bg-green-600 hover:bg-gray-700 text-white rounded-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                            Изменить
                        </a>
