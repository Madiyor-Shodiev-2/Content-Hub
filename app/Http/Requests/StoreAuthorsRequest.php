...
class StoreAuthorsRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|unique:authors,name|max:255|min:6',
            'url' => 'required|url|unique:authors,url',
            'bio' => 'max:500'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'name.unique' => 'Такая имя автора уже существует!',
            ...
            'url.unique' => 'Такая ссылка уже есть у других авторов'
        ];
    }
}
